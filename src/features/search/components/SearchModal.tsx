...
import { useLabels, useSearchThreads, isSyncReady } from '@/src/features/gmail';
import { getProvider } from '@/src/features/ai';
import type { SearchParams } from '@/src/features/search';
...
export default function SearchModal({
  ...
  const {
    ...
    isLoading,
    isFetching,
  } = useSearchThreads(accountId, searchParams, (messages) =>
