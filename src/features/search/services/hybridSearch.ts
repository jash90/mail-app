import {
  ...
  isFTSIndexEmpty,
  rebuildFTSIndex,
} from '@/src/shared/db/repositories/search';
import { searchThreadsWithFilters } from '@/src/shared/db/repositories/threads';
...
export async function hybridSearch(
  ...
  // Step 3: AI reranking (requires injected generate function)
  if (results.length > 1 && params.generateFn) {
