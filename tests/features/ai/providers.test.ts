import { getProvider, getActiveProviderName } from '@/features/ai/providers';

// ── Mocks ─────────────────────────────────────────────────────────────

jest.mock('@/features/ai/providers/cloud', () => ({
  cloudProvider: { name: 'cloud', generate: jest.fn() },
}));

jest.mock('@/features/ai/providers/local', () => ({
...
jest.mock('@/store/aiSettingsStore', () => ({
  useAiSettingsStore: {
