import { searchViaGmailApi } from '@/features/search/gmailApiSearch';

// ── Mocks ─────────────────────────────────────────────────────────────

const mockGmailRequest = jest.fn();

jest.mock('@/features/gmail/api', () => ({
  gmailRequest: (...args: unknown[]) => mockGmailRequest(...args),
}));

jest.mock('@/features/gmail/threads', () => ({
...
jest.mock('@/db/repositories/labels', () => ({
  getLabels: jest.fn(() => [
